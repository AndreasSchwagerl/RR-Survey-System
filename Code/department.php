...
echo "<tr><th></th> <th>ID</th> <th>Name</th> <th>Completion</th> <th></th> <th></th><th></th></tr>";
...
echo '<td><a href="participant.php?ID=' . $row['ID'] . '"><input type="submit" name="submit" value="Select"></a></td>';
